        ...
        <div class="conn-body">
            ...
            <aside class="group-side">
                ...
                <div class="group-list">
                    ...
                    <div
                        class="group-item"
                        :class="{ active: selectedGroup === NONE }"
                    ...
                    >
                        ...
                        <span class="group-actions">
                            <el-icon title="重命名" @click.stop="renameGroup(g.name)"><Edit /></el-icon>
                            <el-icon title="删除分组" class="danger" @click.stop="removeGroup(g.name)"><Delete /></el-icon>
                        </span>
                    </div>
                </div>
            </aside>
                    ...
                    <el-table-column label="分组" width="180">
                        <template #default="{ row }">
                            <el-select
                                ...
                                placeholder="未分组"
                                @change="(v: string) => setRowGroup(row, v)"
                            >
                        ...
                        <template #default="{ row }">
                            <div class="conn-actions">
                                <template v-if="row.type === 'ssh'">
                                    <el-button size="small" type="primary" plain @click="openTerminal(row)">终端</el-button>
...
import { Plus, Key, Edit, Delete, Folder, Menu } from '@element-plus/icons-vue'
