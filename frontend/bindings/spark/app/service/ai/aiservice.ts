...
export function Cancel(requestID: string): $CancellablePromise<void> {
    return $Call.ByID(1261405022, requestID);
}
...
export function ChatStream(requestID: string, messages: types$0.ChatMessage[] | null): $CancellablePromise<void> {
    return $Call.ByID(4281964146, requestID, messages);
}
...
export function Complete(systemPrompt: string, userContent: string): $CancellablePromise<string> {
    return $Call.ByID(1402911027, systemPrompt, userContent);
}
...
export function CompleteStream(requestID: string, systemPrompt: string, userContent: string): $CancellablePromise<void> {
    return $Call.ByID(3757065595, requestID, systemPrompt, userContent);
}
...
export function SaveConfig(cfg: types$0.AIConfig, apiKey: string): $CancellablePromise<void> {
    return $Call.ByID(1149932747, cfg, apiKey);
}
