...
export function Create(shell: string, dir: string, rows: number, cols: number): $CancellablePromise<string> {
    return $Call.ByID(1186817776, shell, dir, rows, cols);
}
...
export function IsRunning(id: string): $CancellablePromise<boolean> {
    return $Call.ByID(1791283227, id);
}
...
export function Resize(id: string, rows: number, cols: number): $CancellablePromise<void> {
    return $Call.ByID(2520291292, id, rows, cols);
}
...
export function Write(id: string, data: string): $CancellablePromise<void> {
    return $Call.ByID(492373075, id, data);
}
